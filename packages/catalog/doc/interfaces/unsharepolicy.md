...
*Defined in [packages/catalog/api.ts:1314](https://github.com/leSamo/javascript-clients/blob/master/packages/catalog/api.ts#L1314)*
...
*Defined in [packages/catalog/api.ts:1308](https://github.com/leSamo/javascript-clients/blob/master/packages/catalog/api.ts#L1308)*
