[@redhat-cloud-services/approval-client](../README.md) › [Globals](../globals.md) › [DefaultApi](defaultapi.md)
...
*Defined in [packages/approval/api.ts:1023](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1023)*
