...
*Defined in [packages/approval/api.ts:1766](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1766)*
...
*Defined in [packages/approval/api.ts:1778](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1778)*
