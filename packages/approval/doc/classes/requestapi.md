...
*Defined in [packages/approval/api.ts:1521](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1521)*
...
*Defined in [packages/approval/api.ts:1537](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1537)*
...
*Defined in [packages/approval/api.ts:1550](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1550)*
...
*Defined in [packages/approval/api.ts:1562](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1562)*
...
*Defined in [packages/approval/api.ts:1574](https://github.com/leSamo/javascript-clients/blob/master/packages/approval/api.ts#L1574)*
