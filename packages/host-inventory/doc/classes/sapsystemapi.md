...
*Defined in [packages/host-inventory/api.ts:2463](https://github.com/leSamo/javascript-clients/blob/master/packages/host-inventory/api.ts#L2463)*
...
*Defined in [packages/host-inventory/api.ts:2480](https://github.com/leSamo/javascript-clients/blob/master/packages/host-inventory/api.ts#L2480)*
