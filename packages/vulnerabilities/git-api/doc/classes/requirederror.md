[@redhat-cloud-services/vulnerabilities-client](../README.md) › [Globals](../globals.md) › [RequiredError](requirederror.md)
...
*Defined in [packages/vulnerabilities/git-api/base.ts:66](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/base.ts#L66)*
...
*Defined in [packages/vulnerabilities/git-api/base.ts:67](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/base.ts#L67)*
