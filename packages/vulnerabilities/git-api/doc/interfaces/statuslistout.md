...
*Defined in [packages/vulnerabilities/git-api/api.ts:1273](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L1273)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:1279](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L1279)*
