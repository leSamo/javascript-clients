...
*Defined in [packages/vulnerabilities/git-api/api.ts:1007](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L1007)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:1001](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L1001)*
