...
*Defined in [packages/vulnerabilities/git-api/api.ts:450](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L450)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:456](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L456)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:462](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L462)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:468](https://github.com/leSamo/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L468)*
